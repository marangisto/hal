...
struct dma2_t
{
    ...
    static constexpr uint8_t DMA1_CH2_3_DMA2_CH1_2 = 10; // DMA1 channel 2 and 3 and DMA2 channel 1 and 2 interrupt
    static constexpr uint8_t DMA1_CH4_5_6_7_DMA2_CH3_4_5 = 11; // DMA1 channel 4, 5, 6 and 7 and DMA2 channel 3, 4 and 5 interrupts
};
...
struct usart7_t
{
    ...
    static constexpr uint8_t USART3_4_5_6_7_8 = 29; // USART3, USART4, USART5, USART6, USART7, USART8 global interrupt
};

static usart7_t& USART7 = *reinterpret_cast<usart7_t*>(0x40011800);

#define HAVE_PERIPHERAL_USART7
...
struct flash_t
{
    ...
    static constexpr uint32_t OBR_RAM_PARITY_CHECK = 0x4000;// RAM_PARITY_CHECK (0 bits)
...
struct can_t
{
    ...
    template<uint32_t X>
    static constexpr uint32_t CAN_FMR_CAN2SB =              // CAN2SB (6 bits)
        bit_field_t<8, 0x3f>::value<X>();
...
template<> struct peripheral_traits<usart7_t>
{
    static void enable() { RCC.APB2ENR |= rcc_t::APB2ENR_USART7EN; }
    static void disable() { RCC.APB2ENR &= ~rcc_t::APB2ENR_USART7EN; }
};

template<> struct peripheral_traits<usart8_t>
{
    static void enable() { RCC.APB2ENR |= rcc_t::APB2ENR_USART8EN; }
    static void disable() { RCC.APB2ENR &= ~rcc_t::APB2ENR_USART8EN; }
};

template<> struct peripheral_traits<usart5_t>
{
    static void enable() { RCC.APB1ENR |= rcc_t::APB1ENR_USART5EN; }
    static void disable() { RCC.APB1ENR &= ~rcc_t::APB1ENR_USART5EN; }
    static void reset() { RCC.APB1RSTR |= rcc_t::APB1RSTR_USART5RST; }
};
