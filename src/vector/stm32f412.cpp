...
template<> void handler<isr::CAN1_TX>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
template<> void handler<isr::CAN1_RX0>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
template<> void handler<isr::CAN1_RX1>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
template<> void handler<isr::CAN1_SCE>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
template<> void handler<isr::TIM12>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
template<> void handler<isr::TIM13>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
template<> void handler<isr::HASH_RNG>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , handler<isr::CAN1_TX>                   // 19: CAN1 TX interrupts
    , handler<isr::CAN1_RX0>                  // 20: CAN1 RX0 interrupts
    , handler<isr::CAN1_RX1>                  // 21: CAN1 RX1 interrupts
    , handler<isr::CAN1_SCE>                  // 22: CAN1 SCE interrupt
    ...
    , handler<isr::TIM12>                     // 43: Timer 12 global interrupt
    , handler<isr::TIM13>                     // 44: Timer 13 global interrupt
    , handler<isr::TIM14>                     // 45: Timer 14 global interrupt
    , 0x0
    , 0x0
    , 0x0
    ...
    , 0x0
    , 0x0
    , handler<isr::TIM6_DACUNDER>             // 54: TIM6 global and DAC12 underrun interrupts
    ...
    , 0x0
    , 0x0
    , handler<isr::HASH_RNG>                  // 80: Hash and Rng global interrupt
