...
void ISR_DMA1_CH2(void) __attribute__ ((weak, alias("__nothing")));
void ISR_DMA1_CH3(void) __attribute__ ((weak, alias("__nothing")));
void ISR_DMA1_CH4(void) __attribute__ ((weak, alias("__nothing")));
void ISR_DMA1_CH5(void) __attribute__ ((weak, alias("__nothing")));
void ISR_DMA1_CH6(void) __attribute__ ((weak, alias("__nothing")));
void ISR_ADC1_2(void) __attribute__ ((weak, alias("__nothing")));
void ISR_USB_HP(void) __attribute__ ((weak, alias("__nothing")));
void ISR_USB_LP(void) __attribute__ ((weak, alias("__nothing")));
...
void ISR_USBWAKEUP(void) __attribute__ ((weak, alias("__nothing")));
...
void ISR_COMP4(void) __attribute__ ((weak, alias("__nothing")));
