...
template<> void handler<interrupt::USART3_4>() __attribute__ ((weak, alias("_Z17__default_handlerv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , handler<interrupt::USART3_4>                  // 29: USART3 and USART4 global interrupt
