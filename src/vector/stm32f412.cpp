...
extern void ISR_TAMP_STAMP(void) __attribute__ ((weak, alias("_Z9__nothingv")));
...
extern void ISR_ADC(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_CAN1_TX(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_CAN1_RX0(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_CAN1_RX1(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_CAN1_SCE(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_EXTI9_5(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM1_BRK_TIM9(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM1_UP_TIM10(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM1_TRG_COM_TIM11(void) __attribute__ ((weak, alias("_Z9__nothingv")));
...
extern void ISR_OTG_FS_WKUP(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM12(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM13(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_TIM14(void) __attribute__ ((weak, alias("_Z9__nothingv")));
...
extern void ISR_OTG_FS(void) __attribute__ ((weak, alias("_Z9__nothingv")));
...
extern void ISR_HASH_RNG(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_FPU(void) __attribute__ ((weak, alias("_Z9__nothingv")));
extern void ISR_SPI4(void) __attribute__ ((weak, alias("_Z9__nothingv")));
...
void (*vectors[])(void) __attribute__ ((section(".vectors"))) =
    ...
    , ISR_CAN1_TX                   // 19: CAN1 TX interrupts
    , ISR_CAN1_RX0                  // 20: CAN1 RX0 interrupts
    , ISR_CAN1_RX1                  // 21: CAN1 RX1 interrupts
    ...
    , ISR_TIM12                     // 43: Timer 12 global interrupt
    , ISR_TIM13                     // 44: Timer 13 global interrupt
    , ISR_TIM14                     // 45: Timer 14 global interrupt
    , 0x0
    , 0x0
    , 0x0
    ...
    , 0x0
    , 0x0
    , ISR_TIM6_DACUNDER             // 54: TIM6 global and DAC12 underrun interrupts
    ...
    , 0x0
    , 0x0
    , ISR_HASH_RNG                  // 80: Hash and Rng global interrupt
